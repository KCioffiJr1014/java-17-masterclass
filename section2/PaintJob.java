...
/*************************************************************************************************************************************
 * PaintJob
    Context: Bob is a wall painter, and he needs your help.
        You have to write a program that helps Bob calculate how many buckets of paint he needs to buy
    ...
    E.g., getBucketCount(7.25, 4.3, 2.35); → should return 14 since the wall area is 31.175,
    ...
    3. In some cases, Bob does not know the width and height of the wall but he knows the area of a wall.
       He needs you to write another method.
        ...
        - The method needs to return a value of type int that represents the number of buckets that Bob needs to buy
            before going to work. To calculate the bucket count, refer to the notes below.
        - If the parameters area or areaPerBucket is less or equal to 0, the method needs to return -1 to indicate an invalid value.
        - If all parameters are valid, the method needs to calculate the number of buckets and return it.

        E.g., getBucketCount(6.26, 2.2); → should return 3 since the wall area is 6.26 and a single bucket can cover an area of 2.2.

    NOTE: Use the method Math.ceil to round the number of calculated buckets (double) then,
        convert it into an int before returning the value from the methods.
 ***************************************************************************************************************************************/
public class PaintJob {
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets) {
        ...
        double neededWallSpace = width * height;
        double coverage = neededWallSpace / areaPerBucket;

        return (int) Math.ceil(coverage - extraBuckets);
    }
